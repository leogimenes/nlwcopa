      ...
      <main>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          <input
            ...
            value={poolTitle} />
          <button
            className='bg-yellow-500 px-6 py-4 rounded font-bold text-gray-900 text-sm uppercase'
        ...
        <div className='mt-10 pt-10 border-t border-gray-600 flex-1 flex divide-x justify-between divide-gray-600'>
